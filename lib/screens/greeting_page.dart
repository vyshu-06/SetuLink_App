                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: const BilingualText(textKey: 'User button', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                        ),
                      ),
                      const SizedBox(height: 20),
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: const BilingualText(textKey: 'Craftizen button', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                        ),
                      ),
                      const SizedBox(height: 30),
                      InkWell(
                        onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const LoginScreen(initialRole: 'admin'))),
                        child: const BilingualText(textKey: 'Admin panel button', style: TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w500)),
                      ),
                      ...
                      Wrap(
                        ...
                        children: [
                          const BilingualText(textKey: 'New to app text', style: TextStyle(color: Colors.white70, fontSize: 13)),
                          InkWell(
                            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const RegisterScreen())),
                            child: const BilingualText(textKey: 'Register now button', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 13)),
                          ),
                        ],
                      ),
                    ],
